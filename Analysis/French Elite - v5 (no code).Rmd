...
ggplot(attributes, aes(x= religion, y =influence.degree )) +
    ...
    geom_smooth()     + xlab("Level of religion") +
  ylab("Degree level of the influence network") +
  ggtitle("More religion, less degree of influence") 
...
ggplot(attributes, aes(x= religion, y =Influence.transitivity )) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth()+ xlab("Level of religion") +
  ylab("Transitivity level of the elite network") +
  ggtitle("More religion, more transitivity in Elite")     
...
ggplot(attributes, aes(x= religion, y =elite.degree )) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth() + xlab("Level of religion") +
  ylab("Degree level of the elite network") +
  ggtitle("More religion, less degree in Elite")   
...
When we compare degree level of the elite network, we see the same negative correlation than the influence network.
...
The results are similar than with the influence network. We have relatively similar level of p-value so that we will not make any conclusion on the relationship between education and position in the elite or what impacts transitivity in this network.

\section*{Conclusion}

The answer to the main problem seems to be clear.
In the case of the French financial elite, one's relation to god does influence its position in his network. 
However, if we can propose some interpretation about the role of religion in elite networks, we will need more data and more analysis to confirm our ideas.
